...
static void json_array(float humidity,float temperature,uint16_t pressure,String particle_1_0,String particle_2_5,String particle_10_
                            ...
                            SensorObj["dust_pm_1.0"] = particle_1_0; 
                            SensorObj["dust_pm_2.5"] = particle_2_5; 
                            SensorObj["dust_pm_10"] = particle_10_;
...
void mqtt_send_to_broker(String particle_1_0, String particle_2_5, String particle_10){
       //     pms90003m_init();
        if(modem.getSignalQuality() > 15 && modem.getSignalQuality() <= 19){
              ...
              R_volt = read_R_phase_voltage();
              Y_volt = read_Y_phase_voltage();
              B_volt = read_B_phase_voltage();
                   
              _frequency = read_Frequency();

              R_pf = read_R_phase_PF();
              Y_pf = read_Y_phase_PF();
              B_pf = read_B_phase_PF();

              json_array(_humidity,_temperature,_pressure,particle_1_0,particle_2_5,particle_10
                               ,R_volt,Y_volt,B_volt,_frequency,R_pf,Y_pf,B_pf,signalQuality);
